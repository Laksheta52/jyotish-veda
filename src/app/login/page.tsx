...
import { Mail, Lock, Eye, EyeOff, Settings, ChevronDown } from 'lucide-react';
            ...
            <div className="w-full max-w-md">
                <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-purple-700 to-purple-600 p-8 text-center relative">
                        ...
                        <p className="text-purple-200">Unlock the secrets of the Cosmos</p>
                    </div>
                    ...
                    <div className="p-8">
                        ...
                        <p className="mt-6 text-center text-gray-600 text-sm">
                            ...
                            <a href="/signup" className="text-purple-600 hover:text-purple-700 font-medium underline">
                                Sign up
                            </a>
                        </p>
                    </div>
